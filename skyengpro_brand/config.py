...
WORKSPACE_RESTRICTIONS = {
    ...
    "Banking":           ["Accounts Manager", "Accounts User"],
    "Taxes":             ["Accounts Manager", "Accounts User"],
    "Budgeting":         ["Accounts Manager", "Accounts User"],
    "Share Management":  ["Accounts Manager"],
    "Subscriptions":     ["Accounts Manager", "Accounts User"],
